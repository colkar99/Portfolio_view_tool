...
require "view_tool_portfolio/version"

Gem::Specification.new do |spec|
  spec.name          = "view_tool_portfolio"
  spec.version       = ViewToolPortfolio::VERSION
  spec.authors       = ["colkar99"]
  spec.email         = ["colkar99@gmail.com"]
